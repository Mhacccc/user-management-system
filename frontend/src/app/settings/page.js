...
export default function SettingsPage() {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            if (cachedRole && !profile.role) {
                setProfile(prev => ({ ...prev, role: cachedRole }));
            }
        }
    }, []);
                ...
                <div>
                    {loading ? (
                        <div className="space-y-4">
                            ...
                            <div className="rounded-md border border-border/40 bg-card/80 p-4 animate-pulse">
                                ...
                                <div className="mt-6 h-10 bg-muted/20 rounded w-32"></div>
                            </div>
                        </div>
                    ) : (
